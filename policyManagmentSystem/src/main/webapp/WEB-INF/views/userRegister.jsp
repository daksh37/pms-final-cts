...
.input::-webkit-outer-spin-button { 
  ...
  <body>
        ...
        <nav class="navbar navbar-light bg-light">
               <a href="userlog.html"> <img src="https://firebasestorage.googleapis.com/v0/b/policy-65ae1.appspot.com/o/logo.png?alt=media&token=3f99482f-6af5-477e-9e56-2e55de640f3c" style="width:170px;height:75px;"></img></a>
               <ul class="navbar-nav ml-auto">
                   ...
                   <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <form class="btnn">
                                <a href="userlog.html" class="btn btn-secondary  form-rounded" >Login</a>
                            </form>
                        </li>
                    </ul>
    ...
    <div class="row">
       ...
       <div class="col-sm-6">
        <label>
                ...
                <input type="text" class="input" name="contactNo" size="10"  pattern="[789][0-9]{9}" required>
                <div class="line-box">
                  <div class="line"></div>
                </div>
              </label>
