...
<body class="align">
        ...
        <div class="grid">
                <h2></h2>
          <form action="checkoutUPI.html" method="POST" class="form login">
...
<h1><input type="hidden" name="id1" value="${id1}">
            ...
            <div class="form__field">
              ...
              <input id="login__username" type="text" name="cardNo" class="form__input" placeholder="Username" required>
            </div>
