                ...
                <div class="col-md-9 bg-light">
                    ...
                    <div class="btn-group col-md-12">
                        ...
                        <div class="col-md-12 bg-light">
                                <form class="mx-2 my-auto d-inline w-20" action="admin/search1.html?id=${user.userId}" method="POST">
...
&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <input id="prodId" name="userId" type="hidden" value=${user.userId}>   
             <button type="submit"  class="btn btn-dark form-rounded" >Search Policy</a>&emsp;&emsp;
</form>
		<a href="admin/addPolicy.html" class="btn btn-dark form-rounded" >Add Policy</a>
<form>
                        </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                              <a href="admin/viewPolicy.html?id=${product.policyId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;View&emsp; 
                              </a>&emsp;&emsp;
								<input id="productId" name="userName" type="hidden" value=${user.userId}>
                             <a href="admin/editPolicy.html?id=${product.policyId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;Edit&emsp; 
                              </a>&emsp;&emsp;
