                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                             ...
                             <a href="remove.html?id=${product.policyId}&id1=${user.userId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;Remove&emsp; 
                              </a>&emsp;&emsp;
                             <a href="addToCart.html?id=${product.policyId}&id1=${user.userId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;Payment&emsp; 
                              </a>&emsp;&emsp;
                             ...
                             <c:when test="${product.productStatus=='1'}">
                              ...
                              <c:otherwise>
                              <a href="" class="btn btn-secondary form-rounded" width="50px" >
                              &emsp;Already Paid&emsp;
                              </c:otherwise>
                              </c:choose> --%>
