package com.cts.policyManagmentSystem.configuration;
...
@ComponentScans(value = { @ComponentScan("com.cts.policyManagmentSystem.dao"),
      @ComponentScan("com.cts.policyManagmentSystem.service") })
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setPackagesToScan("com.cts.policyManagmentSystem.bean");
      return factoryBean;
   }
